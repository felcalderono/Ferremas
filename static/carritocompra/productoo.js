       ...
       // }
        ...
        function confirmarPago(){
            ...
            var numeroPedido = Math.floor(Math.random() * 90000) + 10000;
            var seguimiento = "FER" + Math.floor(Math.random() * 900000);
            var usuario = document.body.getAttribute("data-usuario");
            
            if(tarjeta === "" || fecha === "" || cvv === "" || run === ""){
            ...
            if(
                ...
                alert("Datos de pago incorrectos");
                return;
            }
           ...
           if(
            ...
            if(tipoEntrega === "sucursal" && sucursal === ""){
            ...
            if(tipoEntrega === "domicilio"){
                ...
                alert(
                    "Pedido confirmado\n\n" +
                    "Cliente: " + document.body.getAttribute("data-usuario") + "\n" +
                ...
                alert(
                    ...
                    "Cliente: " + document.body.getAttribute("data-usuario") + "\n" +
                    "Pedido N°: " + numeroPedido + "\n\n" +
                    "Tu pedido estará listo en un máximo de 3 días hábiles.\n" +
                    "Sucursal: " + sucursal
                );
